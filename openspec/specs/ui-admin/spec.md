# ui-admin Specification

## Purpose
Admin de tenant: layout con sub-rutas, gating por permisos y pantallas
resumen-primero para configurar la organización, el asistente y sus
conexiones.
